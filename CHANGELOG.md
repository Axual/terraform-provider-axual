...
## [2.5.7](https://github.com/Axual/terraform-provider-axual/releases/tag/v2.5.7) - 2026-01-09
...
* Fix state inconsistency bugs in `axual_application_access_grant` and `axual_application_deployment` resources
