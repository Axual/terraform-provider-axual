...
Topic Config resource. Once the Topic has been created, the next step to actually configure the topic for any environment is to configure the topic. Read more: https://docs.axual.io/axual/2026.1/self-service/topic-management.html#configuring-a-topic-for-an-environment
...
- `partitions` (Number) The number of partitions define how many consumer instances can be started in parallel on this topic. Read more: https://docs.axual.io/axual/2026.1/self-service/topic-management.html#partitions-number
