...
- `settings` (Map of String) A list of Environment specific settings in Key,Value format.
...
## Limitations
- If no settings please leave properties empty like this: settings = { }. Removing settings does not currently remove settings.
