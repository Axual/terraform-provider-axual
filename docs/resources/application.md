...
There might be issues when doing the hybrid setup: changing some resources in UI and then using Terraform to change the state of those resources.
These issues are planned to be worked on.
