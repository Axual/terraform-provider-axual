...
```shell
terraform import axual_topic_browse_permissions.<LOCAL NAME> <TOPIC CONFIG UID>
terraform import axual_topic_browse_permissions.support_browse_users_and_groups b21cf1d63a55436391463cee3f56e393
```