...
# `tasks.max` must be a number: the connect plugin refuses the value and the Platform Manager
# answers "Invalid config uploaded", which the provider has to report rather than swallow.
