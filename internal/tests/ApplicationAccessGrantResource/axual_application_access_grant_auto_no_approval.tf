# Test: Auto environment - grant is auto-approved, NO approval resource
# This tests the new auto-revoke on delete behavior in the grant resource.
#
# Previously, this would fail with:
#   "Application Access Grant cannot be cancelled. Please Revoke first."
#
# With the fix, grant.Delete() now auto-revokes approved grants before removing from state.
...
# Grant without approval resource - tests auto-revoke on delete
