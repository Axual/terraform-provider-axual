	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"key_type": schema.StringAttribute{
				MarkdownDescription: "The key type and reference to the schema (if applicable). Read more: https://docs.axual.io/axual/2024.4/self-service/topic-management.html#key-type",
				Computed:            true,
			},
			"value_type": schema.StringAttribute{
				MarkdownDescription: "The value type and reference to the schema (if applicable). Read more: https://docs.axual.io/axual/2024.4/self-service/topic-management.html#value-type",
				Computed:            true,
			},
			...
			"properties": schema.MapAttribute{
				MarkdownDescription: "Advanced (Kafka) properties for a topic in a given environment. Read more: https://docs.axual.io/axual/2024.4/self-service/advanced-features.html#configuring-topic-properties",
				Computed:            true,
